            ...
            <>
                        ...
                        <tr key={s._id} className="hover:bg-slate-50/50 transition-colors">
                          ...
                          <td className="px-4 py-3">
                            <div className="flex items-center gap-3">
                              <div className={`w-8 h-8 rounded flex items-center justify-center text-white font-bold text-xs ${avatarColors[i % avatarColors.length]}`}>
              ...
              <div className="block md:hidden p-4 space-y-3 bg-slate-50/50">
                {filteredData.map((s, i) => {
                  const badge = getPctBadge(s.percent);
                  return (
                    <div key={s._id} className="bg-white p-4 rounded-md border border-slate-100 shadow-sm flex flex-col gap-3.5 transition duration-200 hover:shadow-md hover:border-indigo-100">
