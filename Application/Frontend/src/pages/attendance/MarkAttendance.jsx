...
const StatusRadio = ({ value, current, onChange }) => {
  ...
  return (
    <label
      className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md cursor-pointer transition border text-xs font-medium
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2.5 border border-slate-200 rounded bg-white text-sm outline-none focus:ring-2 focus:ring-indigo-400 cursor-pointer"
              >
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border border-slate-200 rounded bg-white text-sm outline-none focus:ring-2 focus:ring-indigo-400"
              />
            </div>
          </div>
        </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-between items-stretch sm:items-center px-5 py-4 border-t border-slate-100">
                  <div className="flex flex-wrap gap-2">
                    <button
                      ...
                      className="flex-1 sm:flex-none px-4 py-2 bg-emerald-600 text-white rounded hover:bg-emerald-700 transition text-xs font-bold flex items-center justify-center gap-1.5"
                    >
                      <FaUserCheck /> Present All
                    </button>
                    <button
                      onClick={() => markAll("Absent")}
                      className="flex-1 sm:flex-none px-4 py-2 bg-rose-600 text-white rounded hover:bg-rose-700 transition text-xs font-bold flex items-center justify-center gap-1.5"
                    >
                      <FaUserTimes /> Absent All
                    </button>
                    <button
                      onClick={() => markAll("Present")}
                      className="flex-1 sm:flex-none px-4 py-2 border border-slate-200 rounded hover:bg-slate-50 transition text-xs font-bold flex items-center justify-center gap-1.5"
                    >
                      <FaBed /> Reset
                    </button>
                  </div>
                  <button
                    onClick={handleSave}
                    disabled={saving}
                    className="w-full sm:w-auto px-6 py-2.5 bg-indigo-600 text-white rounded hover:bg-indigo-700 transition flex items-center justify-center gap-2 disabled:opacity-50 text-xs font-bold shadow-md shadow-indigo-100"
                  >
                    {saving ? (
