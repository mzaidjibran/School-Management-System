      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-6 lg:gap-4 text-center lg:text-left">
          ...
          <div className="text-center lg:text-right text-xs text-slate-400 space-y-1">
            <p>
              © {currentYear} School ERP •{" "}
              <span className="font-mono text-[10px] bg-slate-100 text-slate-500 px-1.5 py-0.5 rounded font-bold border border-slate-200/30">
                v1.0.0
              </span>
            </p>
            <p className="text-slate-400">
              Developed by{" "}
              <span className="text-indigo-500 font-bold hover:text-indigo-600 transition duration-150 cursor-pointer">
                Null Stack Solutions
              </span>
            </p>
          </div>
        </div>
